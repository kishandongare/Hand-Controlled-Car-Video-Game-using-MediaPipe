...
class CarRacing:
    ...
    def initialize(self):
        ...
        self.enemy_car_startx = random.randrange(260, 450)
    ...
    def run_car(self):
        ...
        while not self.crashed:
            ...
            if self.car_x_coordinate < 200 or self.car_x_coordinate > 460:
                self.crashed = True
                self.display_message("Game Over !!!")
    ...
    def highscore(self, count):
        ...
        self.gameDisplay.blit(text, (250, 0))

    def display_credit(self):
        font = pygame.font.SysFont("lucidaconsole", 14)
        text = font.render("Thanks for playing!", True, self.white)
        self.gameDisplay.blit(text, (520, 520))
